...
|------|--------------|-----------|
| `Cleaned_Test_Data_step4_corrected.csv` | Historical PQL dataset (9 ,770 rows). Includes `customer_id`, `ws_created_at`, `pql_created_at`, `company_segment`, `company_sales_region`, `company_employees`. | [📥 Download](sandbox:/mnt/data/Cleaned_Test_Data_step4_corrected.csv) |
